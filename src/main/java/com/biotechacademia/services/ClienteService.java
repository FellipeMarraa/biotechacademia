...
import com.biotechacademia.dto.ClienteDTO;
import com.biotechacademia.dto.ClienteNewDTO;
...
public class ClienteService {
	...
	public void delete(Integer id) {
		...
		repo.deleteById(id);
			...
			throw new DateIntegrityException("Não é possível excluir por que há entidades relacionadas");
		}
	}
